...
function onCreate(){
	var sky = new BGSprite("stages/philly/erect/sky", -100, 0, 0.1, 0.1);
	insert(members.indexOf(gfGroup), sky);
	spritePhillyGlow.push(sky);
	
	
	var city = new BGSprite("stages/philly/erect/city", -255, 45, 0.3, 0.3);
	...
	var behindTrain = new BGSprite("stages/philly/erect/behindTrain", -299, 144);
	...
	var street = new BGSprite("stages/philly/erect/street", -299, 144);
